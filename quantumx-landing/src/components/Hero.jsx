...
export default function Hero() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 pt-8 pb-28 sm:pt-16 sm:pb-32">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#FBC737]/[0.03] rounded-full blur-[120px] z-0" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full space-y-6 sm:space-y-8">
        ...
        <h1 className="hero-headline text-[1.75rem] sm:text-4xl md:text-5xl lg:text-[3.5rem] font-extrabold leading-[1.1] px-0 w-full">
          QuantumX è l'unico sistema di trading che utilizza il{' '}
          <span className="underline decoration-[#FBC737] decoration-4 underline-offset-4">'Metodo Magnitudo'</span>{' '}
          per trasformare i <strong className="text-[#FBC737]">cali del mercato</strong> nelle tue{' '}
          <span className="underline decoration-[#FBC737] decoration-4 underline-offset-4">migliori opportunità</span>
        </h1>

        {/* Subheadline */}
        <p className="hero-sub text-base sm:text-xl md:text-2xl text-[#BCD2EE] max-w-3xl mx-auto leading-relaxed">
          L'unico sistema di trading <strong className="text-white">AUTOMATICO</strong> che utilizza il{' '}
          <em>Metodo di Wall Street</em> per trasformare i crolli di mercato in{' '}
          <strong className="text-white">profittevoli opportunità</strong>.
        </p>
        ...
        <div className="hero-vsl w-full max-w-3xl mx-auto">
          <div className="relative aspect-video bg-[#1A2346] rounded-2xl border border-white/10 overflow-hidden group cursor-pointer shadow-[0_0_60px_rgba(0,0,0,0.5)]">
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-[#FBC737] rounded-full flex items-center justify-center shadow-[0_0_40px_rgba(251,199,55,0.5)] group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="absolute bottom-4 left-0 right-0 text-center z-10">
              <span className="text-xs sm:text-sm text-white/50 font-medium">Guarda la Presentazione del Metodo Magnitudo</span>
            </div>
          </div>
        </div>

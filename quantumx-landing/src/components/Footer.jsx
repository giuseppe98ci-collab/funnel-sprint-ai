    ...
    <footer className="py-12 bg-[#00051a] border-t border-white/5 text-center text-sm text-gray-500">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex gap-6">
          <a href="#" className="hover:text-[#FBC737] transition-colors">Privacy Policy</a>
          <a href="#" className="hover:text-[#FBC737] transition-colors">Termini e Condizioni</a>
          <a href="#" className="hover:text-[#FBC737] transition-colors">Disclaimer</a>
        </div>
        <div>

...
export default function CTA() {
  ...
  return (
    <section ref={ref} className="py-16 sm:py-24 px-4 bg-gradient-to-b from-[#010B32] to-[#0a1545] relative overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#FBC737]/[0.06] blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="cta-content max-w-3xl mx-auto text-center relative z-10">
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 sm:mb-6 leading-tight">
          ...
          <span className="underline decoration-[#FBC737] decoration-4 underline-offset-4">Prima del Prossimo Calo</span>
        </h2>
        ...
        <div className="bg-[#1A2346]/60 border border-white/5 rounded-2xl p-6 sm:p-8 mb-8">
          <p className="text-sm sm:text-base text-[#BCD2EE] mb-6">
            ...
            <span className="underline decoration-[#FBC737] underline-offset-2">Metodo Magnitudo</span> potrebbe trasformare il tuo approccio ai mercati.
          </p>
          <div className="flex flex-wrap justify-center gap-3 sm:gap-6 text-sm sm:text-base text-[#FBC737] font-semibold mb-6">

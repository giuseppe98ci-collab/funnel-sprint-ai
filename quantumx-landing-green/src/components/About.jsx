...
const benefits = [
  ...
  <>Gestisci il rischio come le <span className="underline decoration-[#10B981] underline-offset-2">istituzioni finanziarie</span></>,
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 sm:gap-16 items-center">
        ...
        <div className="about-img relative order-2 md:order-1">
          ...
          <img
            ...
            alt="Antonio Vida"
            className="relative z-10 w-full max-w-sm mx-auto md:max-w-none rounded-2xl border border-[#10B981]/20 shadow-[0_0_40px_rgba(16,185,129,0.15)]"
            loading="lazy"
          />
          <div className="absolute -bottom-4 right-4 sm:-bottom-5 sm:-right-4 bg-[#1A2346] px-4 py-3 rounded-xl border border-white/10 shadow-xl z-20">
            <p className="font-bold text-[#10B981] text-sm sm:text-base">Antonio Vida</p>
        ...
        <div className="space-y-6 sm:space-y-8 order-1 md:order-2">
          <h2 className="about-text text-2xl sm:text-3xl md:text-5xl font-bold leading-tight">
            Da <span className="underline decoration-[#10B981] decoration-4 underline-offset-4">Wall Street</span> al Tuo Conto di Trading
          </h2>
          ...
          <div className="about-text space-y-4 text-[#BCD2EE] text-base sm:text-lg leading-relaxed">
            ...
            <blockquote className="border-l-4 border-[#10B981] pl-4 italic text-white/90 text-base sm:text-lg">
              "Ho visto le principali società utilizzare <span className="underline decoration-[#10B981] underline-offset-2">approcci sistematici</span> per identificare opportunità durante i cali del mercato, mentre i trader di tutti i giorni seguivano strategie obsolete."
            </blockquote>
            <p>
              Il <strong className="text-white">"Metodo Magnitudo"</strong> è un framework matematico perfezionato in <span className="underline decoration-[#10B981] underline-offset-2">26 anni</span> che identifica in autonomia i migliori punti di ingresso.
            </p>
          </div>

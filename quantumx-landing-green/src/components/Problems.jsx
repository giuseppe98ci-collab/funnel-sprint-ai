...
const problems = [
  ...
  },
  {
    ...
    question: <>Stanco di perderti i <span className="underline decoration-[#10B981] underline-offset-2">migliori punti di ingresso</span> perché lasci che siano le <em>tue emozioni</em> a gestire i tuoi trade?</>,
  },
  {
  ...
  },
  {
    ...
    question: <>Ti stai chiedendo perché gli "esperti" sembrano <span className="underline decoration-[#10B981] underline-offset-2">trarre vantaggio dalla volatilità</span> mentre tu resti indietro?</>,
  },
];
    ...
    <section ref={sectionRef} className="relative py-16 sm:py-24 px-4 bg-[#010B32] overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <h2 className="problem-title text-2xl sm:text-3xl md:text-5xl font-bold text-center mb-10 sm:mb-14 leading-tight">
          Il problema del{' '}
          <span className="underline decoration-[#10B981] decoration-4 underline-offset-4">Trading Tradizionale</span>
        </h2>
        ...
        <div className="space-y-4 sm:space-y-5">
          {problems.map((p, i) => (
            <div
              key={i}
              className="problem-item flex items-start gap-4 bg-[#1A2346]/60 border border-white/5 rounded-xl p-5 sm:p-6 hover:border-[#10B981]/20 transition-colors duration-300"
            >
              <div className="flex-shrink-0 mt-0.5 text-[#10B981]">{p.icon}</div>
        ...
        <div className="problem-solution mt-10 sm:mt-14 text-center">
          <div className="inline-block bg-[#10B981]/10 border border-[#10B981]/20 rounded-2xl px-6 py-5 sm:px-8 sm:py-6">
            ...
            <p className="text-sm sm:text-base text-[#BCD2EE]">
              ...
              <span className="underline decoration-[#10B981] underline-offset-2">approccio completamente diverso</span>.
            </p>
          </div>
        </div>
      </div>

...
const features = [
  {
    ...
    desc: <>Formula collaudata per <strong className="text-white">26 anni</strong> finalmente disponibile. Mentre tutti usavano gli stessi schemi grafici, le grandi società di Wall Street usavano qualcosa di <span className="underline decoration-[#FF6B00] underline-offset-2">completamente diverso</span>.</>,
    accent: '#FF6B00',
  },
  {
  ...
  },
  {
    ...
    desc: <>Replica le <span className="underline decoration-[#FF6B00] underline-offset-2">strategie dei grandi fondi hedge</span> direttamente sul tuo conto retail. Non serve capitale milionario, serve solo la <strong className="text-white">strategia giusta</strong>.</>,
    accent: '#00b67a',
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="feat-title text-2xl sm:text-3xl md:text-5xl font-bold mb-4">
            Come <span className="underline decoration-[#FF6B00] decoration-4 underline-offset-4">QuantumX</span> cambia TUTTO
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {features.map((f, i) => (
            <div
              key={i}
              className="feat-card group bg-[#1A2346]/70 border border-white/5 rounded-2xl p-6 sm:p-8 hover:border-[#FF6B00]/30 transition-all duration-500 hover:translate-y-[-4px] hover:shadow-[0_20px_60px_rgba(0,0,0,0.3)]"
            >
              <div
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-3 text-white group-hover:text-[#FF6B00] transition-colors">
                {f.title}
              </h3>

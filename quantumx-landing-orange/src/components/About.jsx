...
const benefits = [
  ...
  <>Gestisci il rischio come le <span className="underline decoration-[#FF6B00] underline-offset-2">istituzioni finanziarie</span></>,
    ...
    <section ref={ref} className="py-16 sm:py-24 px-4 bg-[#010B32] relative">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 sm:gap-16 items-center">
        ...
        <div className="about-img relative order-2 md:order-1">
          <div className="absolute inset-0 bg-[#FF6B00]/10 blur-3xl rounded-full" />
          <img
            src="https://assets.cdn.filesafe.space/CpX4gKwB6buyGxFgkoA1/media/a3161f4b-9633-4d9b-99d9-689e7ab5151d.png"
            alt="Antonio Vida"
            className="relative z-10 w-full max-w-sm mx-auto md:max-w-none rounded-2xl border border-[#FF6B00]/20 shadow-[0_0_40px_rgba(255,107,0,0.15)]"
            loading="lazy"
          />
          <div className="absolute -bottom-4 right-4 sm:-bottom-5 sm:-right-4 bg-[#1A2346] px-4 py-3 rounded-xl border border-white/10 shadow-xl z-20">
            <p className="font-bold text-[#FF6B00] text-sm sm:text-base">Antonio Vida</p>
        ...
        <div className="space-y-6 sm:space-y-8 order-1 md:order-2">
          <h2 className="about-text text-2xl sm:text-3xl md:text-5xl font-bold leading-tight">
            Da <span className="underline decoration-[#FF6B00] decoration-4 underline-offset-4">Wall Street</span> al Tuo Conto di Trading
          </h2>
          ...
          <div className="about-text space-y-4 text-[#BCD2EE] text-base sm:text-lg leading-relaxed">
            ...
            <blockquote className="border-l-4 border-[#FF6B00] pl-4 italic text-white/90 text-base sm:text-lg">
              "Ho visto le principali società utilizzare <span className="underline decoration-[#FF6B00] underline-offset-2">approcci sistematici</span> per identificare opportunità durante i cali del mercato, mentre i trader di tutti i giorni seguivano strategie obsolete."
            </blockquote>
            <p>
              Il <strong className="text-white">"Metodo Magnitudo"</strong> è un framework matematico perfezionato in <span className="underline decoration-[#FF6B00] underline-offset-2">26 anni</span> che identifica in autonomia i migliori punti di ingresso.
            </p>
          </div>
          ...
          <ul className="about-text space-y-3">
            {benefits.map((b, i) => (
              <li key={i} className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-[#FF6B00]/20 flex items-center justify-center text-[#FF6B00] flex-shrink-0 mt-0.5">
